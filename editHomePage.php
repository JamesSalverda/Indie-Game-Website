<!-- James Salverda
     November 5, 2019
     Final Project
     allows the authorized user to edit a post or choose to delete it. prompts user to sign in -->
...
<?php
    ...
    if ($_POST && isset($_POST['title']) && isset($_POST['content'])) {
        ...
        $query     = "UPDATE homepage SET title = :title, content = :content WHERE postID = :postID";
...
<body>
    ...
    <div id="New">
        <?php if ($id): ?>
            ...
            <form method="post" action="editHomePage.php?postID=<?=$quote['postID']?>">
            ...
            <form method="post" action="homePageDelete.php" >
